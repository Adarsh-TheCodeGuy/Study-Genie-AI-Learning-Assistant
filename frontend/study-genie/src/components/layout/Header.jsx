            ...
            <div className='flex items-center gap-3'>
                ...
                <div className='flex items-center gap-3 pl-3 border-l border-slate-200/60'>
                    <div className='flex items-center gap-3 px-3 py-1.5 rounded-xl hover:bg-slate-50 transition-colors duration-200 cursor-pointer group'>
                        <div className='w-9 h-9 rounded-xl bg-linear-to-br from-emerald-400 to-teal-500 flex items-center justify-center text-white shadow-md shadow-emeral-500/20 group-hover:shadow-lg group-hover:shadow-emerald-500/30 transition-all duration-200'>
