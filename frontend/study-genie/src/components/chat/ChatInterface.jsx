...
const ChatInterface = () => {
  ...
  if (initialLoading) {
    return (
      <div className="flex flex-col h-[70vh] bg-white/80 backdrop-blur-xl border-slate-200/60 rounder-2xl items-center justify-center shadow-xl shadow-slate-200/60">
  ...
  return (
    <div className="flex flex-col h-[70vh] bg-white/80 backdrop-blur-xl border-slate-200/60 shadow-xl shadow-slate-200/60 overflow-hidden">
      {/* Message Area */}
      <div className="flex-1 p-6 overflow-y-auto bg-linear-to-br from-slate-50/50 via-white/50 to-slate-50">
        {history.length === 0 ? (
      ...
      {/* Input Area */}
      <div className="p-5 border-t border-slate-200/60 bg-white/60">
        <form onSubmit={handleSendMessage} className="flex items-center gap-3">
          <input 
            ...
            className="flex-1 h-12 px-4 border-2 border-slate-200 rounded-xl bg-slate-50/50 text-slate-900 placeholder:text-slate-500 text-sm font-medium transition-all duration-200 focus:outline-none focus:border-emerald-500 focus:bg-white focus:shadow-lg focus:shadow-emerald-500/10"
            disabled={loading}
          />
          <button
            type="submit"
