...
const DashboardPage = () => {
  ...
  return (
    <div className='relative min-h-screen flex-1 overflow-hidden bg-gradient-to-br from-slate-50 via-white to-slate-100'>
      ...
      <div className='relative max-w-7xl mx-auto'>
        ...
        <div className='bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-xl shadow-slate-200/50 p-6'>
          ...
          {dashboardData.recentActivity && (dashboardData?.recentActivity?.documents?.length > 0 || dashboardData?.recentActivity?.quizzez?.length > 0) ? (
            <div className='space-y-3'>
              {[
                ...
                ...(dashboardData.recentActivity.quizzez || []).map(quiz => ({
                  id: quiz._id,
